<template>
	<pageWrapper>
		...
		<view class="game-list" v-if="state.games.length > 0">
			<view
				class="game-item"
				v-for="(item, index) in state.games"
				:key="item.id"
			>
			...
			<scroll-view scroll-y class="scroll-content">
				<view class="modal-body">
					...
					<view class="form-item">
						...
						<up-input
							v-model="state.tempGame.type"
							placeholder="桌游、互动、技巧等"
							border="surround"
						></up-input>
					</view>
					<view class="form-item">
					...
					<view class="form-item">
						...
						<up-input
							v-model="state.tempGame.playerCount"
							placeholder="如: 2-6人"
							border="surround"
						></up-input>
					</view>
					<view class="form-item">
						...
						<up-input
							v-model="state.tempGame.likeRate"
							placeholder="如: 87%"
							border="surround"
						></up-input>
					</view>
					...
					<view class="form-item switch-item">
						...
						<up-switch
							v-model="state.tempGame.isActive"
							color="#07c160"
						></up-switch>
					</view>
				</view>
	...
	state.games = [
		{
			...
			type: "桌游",
			description:
				"经典的社交推理游戏，适合多人参与，通过语言和逻辑找出隐藏的狼人。",
			playerCount: "8-18人",
			likeRate: "89%",
		...
		},
		{
			...
			type: "桌游",
			description:
				"以三国为背景的策略卡牌游戏，玩家扮演不同角色，通过技能和策略获胜。",
			playerCount: "2-10人",
			likeRate: "85%",
