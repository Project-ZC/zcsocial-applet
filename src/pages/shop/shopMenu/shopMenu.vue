    ...
    <view>
      ...
      >
        ...
        <template #actions="{ item, index }">
          <up-button type="primary" size="mini" @click="editGoods(item, index)" class="action-btn">编辑</up-button>
          ...
          <up-button type="warning" size="mini" @click="downGoods(item, index)" class="action-btn">下移</up-button>
        </template>
      </vertical-tabs>
    </view>
