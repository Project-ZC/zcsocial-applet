        ...
        <template #content>
          <view class="content">
            ...
            <view class="goods-card">
              <view class="goods-item z-glass-card" v-for="(item, index) in goodsList" :key="index">
                <!-- 第一列：商品图片 -->
...
// 编辑商品
const editGoods = (item: GoodsItem, index: number) => {
...
// 删除商品
const deleteGoods = (item: GoodsItem, index: number) => {
  uni.showModal({
    title: '确认删除',
