	...
	<pageWrapper>
		<view class="container">
			...
			<view class="header z-glass-card">
				...
				<up-button class="add-btn" type="gradient1" @click="openAddTicketModal"
					>新增门票</up-button
				>
			</view>
					...
					<view class="ticket-header">
						...
						<view class="ticket-price">
							...
							<view class="price-display">
								...
								<text class="price-symbol z-price">¥</text>
								<text class="price-value z-price">{{
									ticket.femalePrice
								}}</text>
							</view>
						</view>
			...
			>
				<view class="z-modal-lg z-modal">
					...
					<view class="modal-footer">
						<up-button type="info" class="modal-btn" @click="closeTicketModal"
							>取消</up-button
						>
						<up-button
							type="gradient1"
				...
				<view class="z-modal z-modal-round">
					...
					<view class="modal-body">
						...
						<view class="drink-diy">
							...
							<view class="drink-item__actions">
								<up-number-box
									...
									integer
									@change="
										onCartItemQtyChange($event, state.drinkQuantities, 0)
									"
								/>
							</view>
						</view>
						...
						<scroll-view scroll-y="true" class="drink-list">
							<view
								v-for="drink in state.filteredDrinks"
								:key="drink.id"
								class="drink-item"
							>
								<view class="drink-item__main">
					...
					<view class="modal-footer">
						<up-button type="info" class="modal-btn" @click="closeDrinkModal"
							>取消</up-button
						>
						<up-button
							type="gradient1"
