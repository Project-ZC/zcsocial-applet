    ...
    <div class="shop">
      ...
      <view class="shop-info-card z-glass-card">
        <view class="shop-header">
          <up-image class="shop-logo" :src="shopInfo.logo" mode="aspectFill" width="140rpx" height="140rpx"></up-image>
        ...
        <view class="shop-switch-section" @click="openShopModal" v-if="state.shopList.length > 0">
          <view class="shop-switch-btn">
            ...
            <view class="shop-count" v-if="state.shopList.length > 1">{{ state.shopList.length }}家店铺</view>
          </view>
        </view>
      </view>
...
const toggleShopStatus = async () => {
  const state = shopInfo.value.state == 'open' ? 'closed' : 'open';
  try {
