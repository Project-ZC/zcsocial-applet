  ...
  <page-wrapper>
    <view class="container">
      ...
      <view class="logo-section">
        <view class="logo">
          <image class="wheat-icon" src="/static/images/logo.png" mode="aspectFit"></image>
        </view>
      ...
      <view class="login-section">
        ...
        <button class="auth-btn" open-type="getUserInfo" @getuserinfo="handleLogin">一键授权登录</button>
        ...
        <view class="agreement-section" v-if="false">
          ...
          <text class="agreement-text">
            ...
            和
            <text class="link" @click.stop="openPrivacyAgreement">《隐私协议》</text>
          </text>
        </view>
      </view>
    </view>
