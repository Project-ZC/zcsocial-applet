	...
	<pageWrapper :showTabbar="true">
		<view class="my-page">
			...
			<view class="user-info-section z-glass-card">
				<view class="user-info-header">
					...
					></up-image> -->
						<up-avatar
							...
							"
							:src="
								getDownloadUrl(userStore.userInfo?.avatar) ||
				...
				<view
					class="edit-btn"
					v-if="userStore.userInfo?.mobile || userStore.userInfo?.isBindMobile"
				>
					<up-button
						type="primary"
						shape="circle"
						@click="navigateTo('/pages/my/editProfile/editProfile')"
					>
						编辑资料
					</up-button>
				</view>
