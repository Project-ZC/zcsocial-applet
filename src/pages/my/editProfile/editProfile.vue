  ...
  <pageWrapper showFooter :scrollTop="60">
    ...
    <template #footer>
      <view class="save-button">
        <up-button class="" type="gradient1" shape="circle" @click="saveProfile">保存</up-button>
      </view>
    </template>
...
.icon-arrow-right {
  width: 20rpx;
  height: 20rpx;
  border-top: 2rpx solid var(--text-3);
  border-right: 2rpx solid var(--text-3);
