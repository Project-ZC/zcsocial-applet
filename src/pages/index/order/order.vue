        ...
        <view class="modal-body" v-if="state.currentProduct">
          <view class="sku-brief">
            <view class="sku-thumb">
              <up-image width="140rpx" height="140rpx" :src="getDownloadUrl(state.currentProduct.photo)" />
            </view>
          ...
          <view v-if="state.currentProduct.productOptions" class="sku-block">
            <view v-for="(opts, key) in state.currentProduct.productOptions" :key="key" class="sku-sub-block">
