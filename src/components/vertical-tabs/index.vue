                      ...
                      <good-card :goodItem="moveItem" :index="moveIndex" :height="height" :margin="margin">
                        <template #actions="{ item, index }">
                          ...
                          <view class="cart-btn" v-if="props.showActionBtn">
                            <up-button type="primary" size="small" shape="circle" @click="openAddToCart(item)">
                              加入购物车
                            </up-button>
                          </view>
                        </template>
...
const { tabs, activeColor, inactiveColor, indicatorColor, backgroundColor, height, width, currentMainType } =
  toRefs(props);
