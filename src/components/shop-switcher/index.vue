					...
					>
						<view class="shop-item-info">
							<view class="shop-item-name">
								...
								<text
									v-if="
										currentShop?.shopConfig.shopId === shop.shopConfig.shopId
									"
									class="current-shop-tag"
								>
									当前
								</text>
							</view>
						...
						<view
							class="shop-item-arrow"
							v-if="currentShop?.shopConfig.shopId === shop.shopConfig.shopId"
						>
